...
data class MqInfoBean(val content: String, val url: String)
...
//果价竞猜
data class GuessInfo(val content: String, val title: String,
                     val totalUser: Int, val quotationHigh: Int, val quotationLight: Int)
